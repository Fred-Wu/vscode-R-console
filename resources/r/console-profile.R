        ...
        tryCatch(
            {
                ...
                if (!("tools:vscode" %in% search()) &&
                    ...
                    # R 4.6 compatibility for vscode-R's legacy deferred attach:
                    # bridge the global .First.sys hook through .First while
                    # preserving the user's own .First startup code.
